<template>
    <section class="relative mt-24 lg:mt-64 overflow-hidden">
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
            <div class="text-center space-y-8 md:space-y-12">
                ...
                <div class="space-y-4 md:space-y-6">
                    <h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.9] max-w-5xl mx-auto tracking-tight"
